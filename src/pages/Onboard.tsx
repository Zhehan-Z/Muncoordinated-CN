...
export default class Onboard extends React.Component<Props, State> {
  ...
  renderNewCommitteeForm = () => {
    ...
    return (
      <React.Fragment>
        {!user && (
          <Message error attached="top" content="Log in or create an account to continue" />
        )}
          ...
          <Form onSubmit={this.handleSubmit}>
            <Form.Group unstackable>
              ...
              <Popup
                ...
                trigger={<Form.Button type="button" icon="question circle outline" width={1} />}
              >
                <Popup.Content>
            ...
            <Form.Input
              ...
              onChange={this.handleInput}
            />
            <Form.Button primary fluid disabled={!this.state.user || this.state.name === ''}>
              Create committee
    ...
    return (
      <Container style={{ padding: '1em 0em' }}>
        <Helmet>
          ...
          <meta
            name="description"
            content="Login, create an account, or create
        ...
        <Grid columns="equal" stackable>
          <Grid.Row>
            <Grid.Column>
              ...
              <Message>
                ...
                <p>
                  Muncoordinated works best with newer versions of{' '}
                  <a href="https://www.google.com/chrome/">Google Chrome</a>. Use of other/older
                  browsers has caused bugs and data loss.
                </p>
              </Message>
            </Grid.Column>
          </Grid.Row>
          <Grid.Row>
            ...
            <Grid.Column>{this.renderNewCommitteeForm()}</Grid.Column>
          </Grid.Row>
        </Grid>
      </Container>
    );
